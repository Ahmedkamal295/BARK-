...
class NextPlumbingVc2: UIViewController {
    ...
    @IBAction func btnView1(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "ProviderNameVC") as? ProviderNameVC
        self.navigationController?.pushViewController(vc!, animated: true)
    }
